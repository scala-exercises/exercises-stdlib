...
Discussion around _exercises-stdlib_ happens in the [GitHub issues](https://github.com/scala-exercises/exercises-stdlib/issues) and [pull requests](https://github.com/scala-exercises/exercises-stdlib/pulls).
...
_exercises-stdlib_ follows a standard [fork and pull](https://help.github.com/articles/using-pull-requests/) model for contributions via GitHub pull requests.
